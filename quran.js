...
QuranData.Sura = [
	...
	[],
	[0, 7, 5, 1, 'ط§ظ„ظپط§طھط­ط©', "Al-Faatiha", 'The Opening', 'Meccan'],
	[7, 286, 87, 40, 'ط§ظ„ط¨ظ‚ط±ط©', "Al-Baqara", 'The Cow', 'Medinan'],
	[293, 200, 89, 20, 'ط¢ظ„ ط¹ظ…ط±ط§ظ†', "Aal-i-Imraan", 'The Family of Imraan', 'Medinan'],
	[493, 176, 92, 24, 'ط§ظ„ظ†ط³ط§ط،', "An-Nisaa", 'The Women', 'Medinan'],
	[669, 120, 112, 16, 'ط§ظ„ظ…ط§ط¦ط¯ط©', "Al-Maaida", 'The Table', 'Medinan'],
	[789, 165, 55, 20, 'ط§ظ„ط£ظ†ط¹ط§ظ…', "Al-An'aam", 'The Cattle', 'Meccan'],
	[954, 206, 39, 24, 'ط§ظ„ط£ط¹ط±ط§ظپ', "Al-A'raaf", 'The Heights', 'Meccan'],
	[1160, 75, 88, 10, 'ط§ظ„ط£ظ†ظپط§ظ„', "Al-Anfaal", 'The Spoils of War', 'Medinan'],
	[1235, 129, 113, 16, 'ط§ظ„طھظˆط¨ط©', "At-Tawba", 'The Repentance', 'Medinan'],
	[1364, 109, 51, 11, 'ظٹظˆظ†ط³', "Yunus", 'Jonas', 'Meccan'],
	[1473, 123, 52, 10, 'ظ‡ظˆط¯', "Hud", 'Hud', 'Meccan'],
	[1596, 111, 53, 12, 'ظٹظˆط³ظپ', "Yusuf", 'Joseph', 'Meccan'],
	[1707, 43, 96, 6, 'ط§ظ„ط±ط¹ط¯', "Ar-Ra'd", 'The Thunder', 'Medinan'],
	[1750, 52, 72, 7, 'ط§ط¨ط±ط§ظ‡ظٹظ…', "Ibrahim", 'Abraham', 'Meccan'],
	[1802, 99, 54, 6, 'ط§ظ„ط­ط¬ط±', "Al-Hijr", 'The Rock', 'Meccan'],
	[1901, 128, 70, 16, 'ط§ظ„ظ†ط­ظ„', "An-Nahl", 'The Bee', 'Meccan'],
	[2029, 111, 50, 12, 'ط§ظ„ط¥ط³ط±ط§ط،', "Al-Israa", 'The Night Journey', 'Meccan'],
	[2140, 110, 69, 12, 'ط§ظ„ظƒظ‡ظپ', "Al-Kahf", 'The Cave', 'Meccan'],
	[2250, 98, 44, 6, 'ظ…ط±ظٹظ…', "Maryam", 'Mary', 'Meccan'],
	[2348, 135, 45, 8, 'ط·ظ‡', "Taa-Haa", 'Taa-Haa', 'Meccan'],
	[2483, 112, 73, 7, 'ط§ظ„ط£ظ†ط¨ظٹط§ط،', "Al-Anbiyaa", 'The Prophets', 'Meccan'],
	[2595, 78, 103, 10, 'ط§ظ„ط­ط¬', "Al-Hajj", 'The Pilgrimage', 'Medinan'],
	[2673, 118, 74, 6, 'ط§ظ„ظ…ط¤ظ…ظ†ظˆظ†', "Al-Muminoon", 'The Believers', 'Meccan'],
	[2791, 64, 102, 9, 'ط§ظ„ظ†ظˆط±', "An-Noor", 'The Light', 'Medinan'],
	[2855, 77, 42, 6, 'ط§ظ„ظپط±ظ‚ط§ظ†', "Al-Furqaan", 'The Criterion', 'Meccan'],
	[2932, 227, 47, 11, 'ط§ظ„ط´ط¹ط±ط§ط،', "Ash-Shu'araa", 'The Poets', 'Meccan'],
	[3159, 93, 48, 7, 'ط§ظ„ظ†ظ…ظ„', "An-Naml", 'The Ant', 'Meccan'],
	[3252, 88, 49, 8, 'ط§ظ„ظ‚طµطµ', "Al-Qasas", 'The Stories', 'Meccan'],
	[3340, 69, 85, 7, 'ط§ظ„ط¹ظ†ظƒط¨ظˆطھ', "Al-Ankaboot", 'The Spider', 'Meccan'],
	[3409, 60, 84, 6, 'ط§ظ„ط±ظˆظ…', "Ar-Room", 'The Romans', 'Meccan'],
	[3469, 34, 57, 3, 'ظ„ظ‚ظ…ط§ظ†', "Luqman", 'Luqman', 'Meccan'],
	[3503, 30, 75, 3, 'ط§ظ„ط³ط¬ط¯ط©', "As-Sajda", 'The Prostration', 'Meccan'],
	[3533, 73, 90, 9, 'ط§ظ„ط£ط­ط²ط§ط¨', "Al-Ahzaab", 'The Clans', 'Medinan'],
	[3606, 54, 58, 6, 'ط³ط¨ط¥', "Saba", 'Sheba', 'Meccan'],
	[3660, 45, 43, 5, 'ظپط§ط·ط±', "Faatir", 'The Originator', 'Meccan'],
	[3705, 83, 41, 5, 'ظٹط³', "Yaseen", 'Yaseen', 'Meccan'],
	[3788, 182, 56, 5, 'ط§ظ„طµط§ظپط§طھ', "As-Saaffaat", 'Those drawn up in Ranks', 'Meccan'],
	[3970, 88, 38, 5, 'طµ', "Saad", 'The letter Saad', 'Meccan'],
	[4058, 75, 59, 8, 'ط§ظ„ط²ظ…ط±', "Az-Zumar", 'The Groups', 'Meccan'],
	[4133, 85, 60, 9, 'ط؛ط§ظپط±', "Al-Ghaafir", 'The Forgiver', 'Meccan'],
	[4218, 54, 61, 6, 'ظپطµظ„طھ', "Fussilat", 'Explained in detail', 'Meccan'],
	[4272, 53, 62, 5, 'ط§ظ„ط´ظˆط±ظ‰', "Ash-Shura", 'Consultation', 'Meccan'],
	[4325, 89, 63, 7, 'ط§ظ„ط²ط®ط±ظپ', "Az-Zukhruf", 'Ornaments of gold', 'Meccan'],
	[4414, 59, 64, 3, 'ط§ظ„ط¯ط®ط§ظ†', "Ad-Dukhaan", 'The Smoke', 'Meccan'],
	[4473, 37, 65, 4, 'ط§ظ„ط¬ط§ط«ظٹط©', "Al-Jaathiya", 'Crouching', 'Meccan'],
	[4510, 35, 66, 4, 'ط§ظ„ط£ط­ظ‚ط§ظپ', "Al-Ahqaf", 'The Dunes', 'Meccan'],
	[4545, 38, 95, 4, 'ظ…ط­ظ…ط¯', "Muhammad", 'Muhammad', 'Medinan'],
	[4583, 29, 111, 4, 'ط§ظ„ظپطھط­', "Al-Fath", 'The Victory', 'Medinan'],
	[4612, 18, 106, 2, 'ط§ظ„ط­ط¬ط±ط§طھ', "Al-Hujuraat", 'The Inner Apartments', 'Medinan'],
	[4630, 45, 34, 3, 'ظ‚', "Qaaf", 'The letter Qaaf', 'Meccan'],
	[4675, 60, 67, 3, 'ط§ظ„ط°ط§ط±ظٹط§طھ', "Adh-Dhaariyat", 'The Winnowing Winds', 'Meccan'],
	[4735, 49, 76, 2, 'ط§ظ„ط·ظˆط±', "At-Tur", 'The Mount', 'Meccan'],
	[4784, 62, 23, 3, 'ط§ظ„ظ†ط¬ظ…', "An-Najm", 'The Star', 'Meccan'],
	[4846, 55, 37, 3, 'ط§ظ„ظ‚ظ…ط±', "Al-Qamar", 'The Moon', 'Meccan'],
	[4901, 78, 97, 3, 'ط§ظ„ط±ط­ظ…ظ†', "Ar-Rahmaan", 'The Beneficent', 'Medinan'],
	[4979, 96, 46, 3, 'ط§ظ„ظˆط§ظ‚ط¹ط©', "Al-Waaqia", 'The Inevitable', 'Meccan'],
	[5075, 29, 94, 4, 'ط§ظ„ط­ط¯ظٹط¯', "Al-Hadid", 'The Iron', 'Medinan'],
	[5104, 22, 105, 3, 'ط§ظ„ظ…ط¬ط§ط¯ظ„ط©', "Al-Mujaadila", 'The Pleading Woman', 'Medinan'],
	[5126, 24, 101, 3, 'ط§ظ„ط­ط´ط±', "Al-Hashr", 'The Exile', 'Medinan'],
	[5150, 13, 91, 2, 'ط§ظ„ظ…ظ…طھط­ظ†ط©', "Al-Mumtahana", 'She that is to be examined', 'Medinan'],
	[5163, 14, 109, 2, 'ط§ظ„طµظپ', "As-Saff", 'The Ranks', 'Medinan'],
	[5177, 11, 110, 2, 'ط§ظ„ط¬ظ…ط¹ط©', "Al-Jumu'a", 'Friday', 'Medinan'],
	[5188, 11, 104, 2, 'ط§ظ„ظ…ظ†ط§ظپظ‚ظˆظ†', "Al-Munaafiqoon", 'The Hypocrites', 'Medinan'],
	[5199, 18, 108, 2, 'ط§ظ„طھط؛ط§ط¨ظ†', "At-Taghaabun", 'Mutual Disillusion', 'Medinan'],
	[5217, 12, 99, 2, 'ط§ظ„ط·ظ„ط§ظ‚', "At-Talaaq", 'Divorce', 'Medinan'],
	[5229, 12, 107, 2, 'ط§ظ„طھط­ط±ظٹظ…', "At-Tahrim", 'The Prohibition', 'Medinan'],
	[5241, 30, 77, 2, 'ط§ظ„ظ…ظ„ظƒ', "Al-Mulk", 'The Sovereignty', 'Meccan'],
	[5271, 52, 2, 2, 'ط§ظ„ظ‚ظ„ظ…', "Al-Qalam", 'The Pen', 'Meccan'],
	[5323, 52, 78, 2, 'ط§ظ„ط­ط§ظ‚ط©', "Al-Haaqqa", 'The Reality', 'Meccan'],
	[5375, 44, 79, 2, 'ط§ظ„ظ…ط¹ط§ط±ط¬', "Al-Ma'aarij", 'The Ascending Stairways', 'Meccan'],
	[5419, 28, 71, 2, 'ظ†ظˆط­', "Nooh", 'Noah', 'Meccan'],
	[5447, 28, 40, 2, 'ط§ظ„ط¬ظ†', "Al-Jinn", 'The Jinn', 'Meccan'],
	[5475, 20, 3, 2, 'ط§ظ„ظ…ط²ظ…ظ„', "Al-Muzzammil", 'The Enshrouded One', 'Meccan'],
	[5495, 56, 4, 2, 'ط§ظ„ظ…ط¯ط«ط±', "Al-Muddaththir", 'The Cloaked One', 'Meccan'],
	[5551, 40, 31, 2, 'ط§ظ„ظ‚ظٹط§ظ…ط©', "Al-Qiyaama", 'The Resurrection', 'Meccan'],
	[5591, 31, 98, 2, 'ط§ظ„ط§ظ†ط³ط§ظ†', "Al-Insaan", 'Man', 'Medinan'],
	[5622, 50, 33, 2, 'ط§ظ„ظ…ط±ط³ظ„ط§طھ', "Al-Mursalaat", 'The Emissaries', 'Meccan'],
	[5672, 40, 80, 2, 'ط§ظ„ظ†ط¨ط¥', "An-Naba", 'The Announcement', 'Meccan'],
	[5712, 46, 81, 2, 'ط§ظ„ظ†ط§ط²ط¹ط§طھ', "An-Naazi'aat", 'Those who drag forth', 'Meccan'],
	[5758, 42, 24, 1, 'ط¹ط¨ط³', "Abasa", 'He frowned', 'Meccan'],
	[5800, 29, 7, 1, 'ط§ظ„طھظƒظˆظٹط±', "At-Takwir", 'The Overthrowing', 'Meccan'],
	[5829, 19, 82, 1, 'ط§ظ„ط¥ظ†ظپط·ط§ط±', "Al-Infitaar", 'The Cleaving', 'Meccan'],
	[5848, 36, 86, 1, 'ط§ظ„ظ…ط·ظپظپظٹظ†', "Al-Mutaffifin", 'Defrauding', 'Meccan'],
	[5884, 25, 83, 1, 'ط§ظ„ط¥ظ†ط´ظ‚ط§ظ‚', "Al-Inshiqaaq", 'The Splitting Open', 'Meccan'],
	[5909, 22, 27, 1, 'ط§ظ„ط¨ط±ظˆط¬', "Al-Burooj", 'The Constellations', 'Meccan'],
	[5931, 17, 36, 1, 'ط§ظ„ط·ط§ط±ظ‚', "At-Taariq", 'The Morning Star', 'Meccan'],
	[5948, 19, 8, 1, 'ط§ظ„ط£ط¹ظ„ظ‰', "Al-A'laa", 'The Most High', 'Meccan'],
	[5967, 26, 68, 1, 'ط§ظ„ط؛ط§ط´ظٹط©', "Al-Ghaashiya", 'The Overwhelming', 'Meccan'],
	[5993, 30, 10, 1, 'ط§ظ„ظپط¬ط±', "Al-Fajr", 'The Dawn', 'Meccan'],
	[6023, 20, 35, 1, 'ط§ظ„ط¨ظ„ط¯', "Al-Balad", 'The City', 'Meccan'],
	[6043, 15, 26, 1, 'ط§ظ„ط´ظ…ط³', "Ash-Shams", 'The Sun', 'Meccan'],
	[6058, 21, 9, 1, 'ط§ظ„ظ„ظٹظ„', "Al-Lail", 'The Night', 'Meccan'],
	[6079, 11, 11, 1, 'ط§ظ„ط¶ط­ظ‰', "Ad-Dhuhaa", 'The Morning Hours', 'Meccan'],
	[6090, 8, 12, 1, 'ط§ظ„ط´ط±ط­', "Ash-Sharh", 'The Consolation', 'Meccan'],
	[6098, 8, 28, 1, 'ط§ظ„طھظٹظ†', "At-Tin", 'The Fig', 'Meccan'],
	[6106, 19, 1, 1, 'ط§ظ„ط¹ظ„ظ‚', "Al-Alaq", 'The Clot', 'Meccan'],
	[6125, 5, 25, 1, 'ط§ظ„ظ‚ط¯ط±', "Al-Qadr", 'The Power, Fate', 'Meccan'],
	[6130, 8, 100, 1, 'ط§ظ„ط¨ظٹظ†ط©', "Al-Bayyina", 'The Evidence', 'Medinan'],
	[6138, 8, 93, 1, 'ط§ظ„ط²ظ„ط²ظ„ط©', "Az-Zalzala", 'The Earthquake', 'Medinan'],
	[6146, 11, 14, 1, 'ط§ظ„ط¹ط§ط¯ظٹط§طھ', "Al-Aadiyaat", 'The Chargers', 'Meccan'],
	[6157, 11, 30, 1, 'ط§ظ„ظ‚ط§ط±ط¹ط©', "Al-Qaari'a", 'The Calamity', 'Meccan'],
	[6168, 8, 16, 1, 'ط§ظ„طھظƒط§ط«ط±', "At-Takaathur", 'Competition', 'Meccan'],
	[6176, 3, 13, 1, 'ط§ظ„ط¹طµط±', "Al-Asr", 'The Declining Day, Epoch', 'Meccan'],
	[6179, 9, 32, 1, 'ط§ظ„ظ‡ظ…ط²ط©', "Al-Humaza", 'The Traducer', 'Meccan'],
	[6188, 5, 19, 1, 'ط§ظ„ظپظٹظ„', "Al-Fil", 'The Elephant', 'Meccan'],
	[6193, 4, 29, 1, 'ظ‚ط±ظٹط´', "Quraish", 'Quraysh', 'Meccan'],
	[6197, 7, 17, 1, 'ط§ظ„ظ…ط§ط¹ظˆظ†', "Al-Maa'un", 'Almsgiving', 'Meccan'],
	[6204, 3, 15, 1, 'ط§ظ„ظƒظˆط«ط±', "Al-Kawthar", 'Abundance', 'Meccan'],
	[6207, 6, 18, 1, 'ط§ظ„ظƒط§ظپط±ظˆظ†', "Al-Kaafiroon", 'The Disbelievers', 'Meccan'],
	[6213, 3, 114, 1, 'ط§ظ„ظ†طµط±', "An-Nasr", 'Divine Support', 'Medinan'],
	[6216, 5, 6, 1, 'ط§ظ„ظ…ط³ط¯', "Al-Masad", 'The Palm Fibre', 'Meccan'],
	[6221, 4, 22, 1, 'ط§ظ„ط¥ط®ظ„ط§طµ', "Al-Ikhlaas", 'Sincerity', 'Meccan'],
	[6225, 5, 20, 1, 'ط§ظ„ظپظ„ظ‚', "Al-Falaq", 'The Dawn', 'Meccan'],
	[6230, 6, 21, 1, 'ط§ظ„ظ†ط§ط³', "An-Naas", 'Mankind', 'Meccan'],
	[6236, 1]
];
